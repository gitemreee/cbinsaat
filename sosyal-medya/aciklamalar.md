...
12 gönderi. Görseller bu klasörde `NN-konu.png` adıyla duruyor (1080×1080).
...
**Görsel:** `01-elektrik.png` · **Grup:** Elektrik · **Renk:** #d3271e

**Görseldeki başlık:** SİGORTA SÜREKLİ ATIYORSA

**Açıklama:**

```
Halk arasında hepsine "sigorta attı" denir ama üç ayrı durum vardır ve çözümleri farklıdır.
...
Malatya genelinde hizmet veriyoruz. 0530 734 60 00

#malatya #cbinsaat #elektrikci #malatyaelektrikci #sigorta #elektrikariza #elektriktesisati #usta
```
...
**Görsel:** `02-elektrik.png` · **Grup:** Elektrik · **Renk:** #d3271e

**Görseldeki başlık:** PRİZ ISINIYORSA BEKLEMEYİN

**Açıklama:**

```
Elinizi dokundurduğunuzda sıcaklık hissediyorsanız orada enerjinin bir kısmı işe değil ısıya dönüşüyor demektir.
...
#malatya #cbinsaat #elektrikci #malatyaelektrikci #priz #guvenlik #elektriktesisati #evbakimi
```
...
**Görsel:** `03-elektrik.png` · **Grup:** Elektrik · **Renk:** #d3271e

**Görseldeki başlık:** PRİZDE ÜÇ UÇ VAR DİYE TOPRAKLAMA VAR SANMAYIN

**Açıklama:**

```
En sık yanılgı bu: prizde toprak fişi görünmesi, arkada gerçekten bir hat olduğu anlamına gelmiyor.
...
#malatya #cbinsaat #elektrikci #malatyaelektrikci #topraklama #elektrikguvenligi #kacakakim #evguvenligi
```
...
**Görsel:** `04-su-kacagi.png` · **Grup:** Su ve Tesisat · **Renk:** #0b7ac4

**Görseldeki başlık:** SU KAÇAĞINI 10 DAKİKADA ANLAYIN

**Açıklama:**

```
Bu test on dakikanızı alır ve temiz su hattında kaçak olup olmadığını net gösterir.
...
#malatya #cbinsaat #sukacagi #tesisat #malatyatesisat #sutesisati #sukacagitespiti #evbakimi
```
...
**Görsel:** `05-gider.png` · **Grup:** Su ve Tesisat · **Renk:** #0b7ac4

**Görseldeki başlık:** AYNI GİDER TEKRAR TEKRAR TIKANIYORSA

**Açıklama:**

```
Tıkanıklığı açmak işin kolay kısmı. Aynı gider üç ayda bir tıkanıyorsa bunu kullanım alışkanlığıyla açıklayamazsınız.
...
#malatya #cbinsaat #giderackma #tikaliklozet #tesisat #malatyatesisatci #lavabo #apartman
```
...
**Görsel:** `06-kis-hazirligi.png` · **Grup:** Su ve Tesisat · **Renk:** #0b7ac4

**Görseldeki başlık:** KIŞ GELMEDEN ŞU 4 ŞEYİ YAPIN

**Açıklama:**

```
Su donduğunda hacmi yaklaşık %9 büyür. Kapalı bir boru içinde bu genişleme gidecek yer bulamaz ve boruyu çatlatır. Kötü haber: çatlak genelde buz çözülene kadar fark edilmez.
...
#malatya #cbinsaat #donanboru #kishazirligi #tesisat #malatya #sutesisati #evbakimi
```
...
**Görsel:** `07-hidrofor.png` · **Grup:** Pompa ve Sulama · **Renk:** #0e8f63

**Görseldeki başlık:** HİDROFOR SÜREKLİ DEVREYE GİRİYORSA

**Açıklama:**

```
Hidrofor arızalarının büyük bölümü pompadan değil, çevresindeki üç parçadan kaynaklanır: basınç tankı, basınç şalteri ve çekvalf.
...
#malatya #cbinsaat #hidrofor #pompa #malatya #subasinci #apartman #tesisat
```
...
**Görsel:** `08-sulama.png` · **Grup:** Pompa ve Sulama · **Renk:** #0e8f63

**Görseldeki başlık:** DAMLATICILAR TIKANMASIN

**Açıklama:**

```
Damlatıcı delikleri milimetrenin altında. En küçük partikül bile zamanla tıkanmaya yol açıyor. İyi haber: tıkanmaların neredeyse tamamı önlenebilir.
...
#malatya #cbinsaat #damlamasulama #sulamasistemi #kayisi #malatya #tarim #bahce
```
...
**Görsel:** `09-isitma.png` · **Grup:** Su ve Tesisat · **Renk:** #0b7ac4

**Görseldeki başlık:** PETEĞİN ALTI SOĞUKSA SEBEP TEK DEĞİL

**Açıklama:**

```
Her kış tekrarlanan şikâyet, ama altında üç farklı sorun yatıyor ve çözümleri tamamen farklı.
...
#malatya #cbinsaat #petektemizligi #kalorifer #kombi #malatya #isitma #kishazirligi
```
...
**Görsel:** `10-banyo-tadilati.png` · **Grup:** Yapı ve Tadilat · **Renk:** #c47100

**Görseldeki başlık:** BANYODA EN PAHALI HATA

**Açıklama:**

```
Banyo tadilatında en pahalıya patlayan hata, su yalıtımını atlamak.
...
#malatya #cbinsaat #banyotadilati #suyalitimi #tadilat #malatyatadilat #insaat #evyenileme
```
...
**Görsel:** `11-tadilat.png` · **Grup:** Yapı ve Tadilat · **Renk:** #c47100

**Görseldeki başlık:** TADİLATA NEREDEN BAŞLANIR?

**Açıklama:**

```
Tadilatta en pahalı hata işlerin sırasını karıştırmak. Sıva atıldıktan sonra hatırlanan bir priz, yeni yapılmış duvarın kırılması demek.
...
#malatya #cbinsaat #tadilat #evtadilati #malatyatadilat #insaat #renovasyon #anahtarteslim
```
...
**Görsel:** `12-hizmet-bolgesi.png` · **Grup:** Yapı ve Tadilat · **Renk:** #c47100

**Görseldeki başlık:** MALATYA'NIN 13 İLÇESİNE GİDİYORUZ

**Açıklama:**

```
Battalgazi ve Yeşilyurt'un yanında Akçadağ, Arapgir, Arguvan, Darende, Doğanşehir, Doğanyol, Hekimhan, Kale, Kuluncak, Pütürge ve Yazıhan. Kırsal mahallelere de aynı ekip gidiyor, başka firmaya havale etmiyoruz.
...
#malatya #cbinsaat #malatya #battalgazi #yesilyurt #darende #elektrikci #tesisatci
```
