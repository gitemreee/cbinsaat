...
export const tesisatMontajServices = [
...

  {
    ...
    faqs: [
      ...
      { q: "Tek bir batarya değişimi için geliyor musunuz?", a: "Geliyoruz ama yol ve iş gücü nedeniyle tek kalemlik işlerde minimum servis bedeli uygulanıyor. Evdeki tüm damlatan armatürleri aynı ziyarette elden geçirmek kalem başına maliyeti hatırı sayılır ölçüde düşürüyor." },
      { q: "Su kesintisi olur mu?", a: "Sadece çalışılan noktanın ara vanası kapatılıyor. Ara vana yoksa daire girişinden kesmek gerekiyor; böyle bir durumda süre birkaç saat olabiliyor. Ara vana takılmasını da aynı işte yapabiliyoruz." },
    ],
...

  {
    ...
    faqs: [
      ...
      { q: "Termostatik başlık işe yarıyor mu?", a: "Yarıyor. Oda hedef sıcaklığa ulaşınca debiyi kısarak hem konforu dengeliyor hem yakıt tüketimini düşürüyor. Özellikle güneş alan ve az kullanılan odalarda farkı büyük." },
    ],
