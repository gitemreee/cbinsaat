...
export const suPosts = [
...

  {
    ...
    updated: "2026-03-25",
    reading: 6,
    metaTitle: "Hidrofor Sürekli Çalışıyor | Nedenleri ve Çözümü",
    metaDesc:
    ...
    keywords: ["hidrofor sürekli çalışıyor", "hidrofor sık devreye giriyor", "basınç tankı", "çekvalf", "basınç şalteri"],
