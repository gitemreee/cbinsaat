...
export default function RootLayout({ children }: Readonly<{children: React.ReactNode}>) {
  const schema = {"@context":"https://schema.org","@type":"GeneralContractor","name":"CB İnşaat","url":"https://cbinsaat.com","email":"info@cbinsaat.com","areaServed":{"@type":"AdministrativeArea","name":"Malatya"},"serviceType":["Elektrik tesisatı","Sıhhi tesisat","Mekanik tesisat","Anahtar teslim inşaat","Su deposu temizliği","Aydınlatma"]};
  return <html lang="tr"><body className={`${display.variable} ${body.variable}`}><script type="application/ld+json" dangerouslySetInnerHTML={{__html:JSON.stringify(schema)}} />{children}</body></html>;
}
