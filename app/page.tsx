...
export default function Home() {
  return <main>
    ...
    <section className="hero">
      <div className="hero-inner">
        ...
        <div className="hero-buttons">
          <a className="btn yellow" href="https://wa.me/905307346000?text=Merhaba%20CB%20%C4%B0n%C5%9Faat%2C%20usta%20ile%20g%C3%B6r%C3%BC%C5%9Fmek%20istiyorum." target="_blank" rel="noreferrer">WHATSAPP'TAN USTA İLE GÖRÜŞ <Arrow /></a>
    ...
    <section className="quote" id="teklif">
      <div className="quote-copy"><p className="eyebrow">ÜCRETSİZ KEŞİF TALEBİ</p><h2>İşinizi anlatın,<br /><mark>biz çözelim.</mark></h2><p>Formu doldurun; işinizin kapsamını konuşmak ve uygun keşif zamanını belirlemek için sizinle iletişime geçelim.</p><a href="https://wa.me/905307346000?text=Merhaba%20CB%20%C4%B0n%C5%9Faat%2C%20usta%20ile%20g%C3%B6r%C3%BC%C5%9Fmek%20istiyorum." target="_blank" rel="noreferrer">◔ WhatsApp: 0530 734 60 00</a></div>
